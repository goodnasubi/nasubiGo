...
from keras.layers import Dense, Dropout, Flatten, Conv2D, MaxPooling2D, AveragePooling2D, LeakyReLU
...
def main(epochs=5, batch_size=128):
    ...
    model.add(Conv2D(32, kernel_size=(3, 3), activation=LeakyReLU(alpha=0.2), input_shape=(28, 28, 1), padding='same'))
    #model.add(Conv2D(64, (3, 3), activation='linear', padding='same'))
    model.add(Conv2D(64, (3, 3), activation=LeakyReLU(alpha=0.2), padding='same'))
    #model.add(Conv2D(64, (3, 3), activation='linear')) # add
